...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cpf: @funcionario.cpf, email: @funcionario.email, nome: @funcionario.nome, senha: @funcionario.senha } }, as: :json
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cpf: @funcionario.cpf, email: @funcionario.email, nome: @funcionario.nome, senha: @funcionario.senha } }, as: :json
    assert_response :success
  end
